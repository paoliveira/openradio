...
public final class M3UPlaylistParser extends AbstractParser {
	...
	public M3UPlaylistParser(final int timeout) {
		super(timeout);
	}
	 ...
	 * @throws IOException 
	 */
    private void parsePlaylist(final InputStream stream, Playlist playlist) throws IOException {
        String line;

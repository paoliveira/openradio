...
public final class PackageValidator {
     ...
     */
    public static boolean isCallerAllowed(final Context context, final String callingPackage, int callingUid) {
        ...
        for (@Nullable final byte[] validSignature : VALID_PUBLIC_SIGNATURES) {
    ...
    private static byte[] extractKey(@NonNull final String keyString) {
        if (AppUtils.ISO_8859_1 == null) {
            return null;
        }
        return keyString.getBytes(AppUtils.ISO_8859_1);
    }
}

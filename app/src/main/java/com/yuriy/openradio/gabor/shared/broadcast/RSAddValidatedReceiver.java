 ...
 */
public final class RSAddValidatedReceiver {
     ...
     */
    public RSAddValidatedReceiver(final RSAddValidatedReceiverListener listener) {
        super();
    ...
    private static final class BroadcastReceiverImpl extends BroadcastReceiver {
        ...
        private final RSAddValidatedReceiverListener mListener;
         ...
         */
        private BroadcastReceiverImpl(final RSAddValidatedReceiverListener listener) {
            super();
            mListener = listener;
        }
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (TextUtils.equals(action, AppLocalBroadcast.getActionValidateOfRSSuccess())) {
                mListener.onSuccess(AppLocalBroadcast.getActionValidateOfRSSuccessMessage(intent));
            }
            if (TextUtils.equals(action, AppLocalBroadcast.getActionValidateOfRSFailed())) {

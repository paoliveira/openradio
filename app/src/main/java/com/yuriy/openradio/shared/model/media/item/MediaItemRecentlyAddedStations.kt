...
import com.yuriy.openradio.shared.model.net.UrlBuilder.recentlyAddedStations
...
class MediaItemRecentlyAddedStations : MediaItemCommandImpl() {
    override fun execute(playbackStateListener: IUpdatePlaybackState?,
        ...
        if (executorService.isShutdown) {
            e("Can not handle MediaItemRecentlyAddedStations, executor is shut down")
    ...
    companion object {
        private val LOG_TAG = MediaItemRecentlyAddedStations::class.java.simpleName
    }
}

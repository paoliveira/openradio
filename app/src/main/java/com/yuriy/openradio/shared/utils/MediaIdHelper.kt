...
object MediaIdHelper {
    ...
    const val MEDIA_ID_RADIO_STATIONS_IN_CATEGORY = "__RADIO_STATIONS_IN_CATEGORY__"
    const val MEDIA_ID_SEARCH_FROM_APP = "__SEARCH_FROM_APP__"
    const val MEDIA_ID_POPULAR_STATIONS = "__POPULAR_STATIONS__"
    const val MEDIA_ID_ALL_STATIONS = "__ALL_STATIONS__"
    const val MEDIA_ID_RECENT_PLAYED_SONGS = "__RECENT_PLAYED_SONGS__"

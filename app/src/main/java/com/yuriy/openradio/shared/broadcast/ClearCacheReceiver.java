 ...
 */
public final class ClearCacheReceiver {
     ...
     */
    public ClearCacheReceiver(final ClearCacheReceiverListener listener) {
        super();
    ...
    private static final class BroadcastReceiverImpl extends BroadcastReceiver {
        ...
        private final ClearCacheReceiverListener mListener;
         ...
         */
        private BroadcastReceiverImpl(final ClearCacheReceiverListener listener) {
            super();
            mListener = listener;
        }

 ...
 */
internal class GoogleDriveQueryFile(isTerminator: Boolean = false) : GoogleDriveQueryDrive(isTerminator) {

    override fun getQueryTask(request: GoogleDriveRequest): Task<FileList> {
        return request.googleApiClient.queryFile(request.fileName)
    }

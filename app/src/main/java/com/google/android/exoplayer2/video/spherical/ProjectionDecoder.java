...
public final class ProjectionDecoder {
  ...
  ArrayList<Mesh> parseProj(ParsableByteArray input) {
  ...
  private static @Nullable
  ArrayList<Mesh> parseMshp(ParsableByteArray input) {
  ...
  private static @Nullable
  ArrayList<Mesh> parseRawMshpData(ParsableByteArray input) {

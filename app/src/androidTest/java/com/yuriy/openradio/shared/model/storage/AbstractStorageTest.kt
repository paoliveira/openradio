...
import com.yuriy.openradio.shared.model.storage.AbstractRadioStationsStorage.Companion.getAllFromString
...
class AbstractStorageTest {
    ...
    fun fromStringToList() {
        ...
        val list = getAllFromString(context, value)
        ...
        for (radioStation in list) {
            MatcherAssert.assertThat(radioStation, IsNull.notNullValue())

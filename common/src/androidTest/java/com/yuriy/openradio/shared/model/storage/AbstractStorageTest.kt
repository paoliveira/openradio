...
class AbstractStorageTest {
    ...
    fun fromStringToList() {
        ...
        val list = storage.getAllFromString(mContext!!, value)
    ...
    fun getAllAddAll() {
        ...
        // No matter what type of storage we use, we need access to its super API.
        val storage = FavoritesStorage()
        storage.clear(mContext!!, storageName)
        ...
        storage.addAll(mContext!!, storageName, list)

        val newList = storage.getAll(mContext!!, storageName)

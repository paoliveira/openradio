...
inline val MediaMetadataCompat.flag
    get() = this.getLong(METADATA_KEY_OR_FLAGS).toInt()
...
inline var MediaMetadataCompat.Builder.flag: Int
    ...
    get() = throw IllegalAccessException("Cannot get from MediaMetadataCompat.Builder")
    set(value) {
        putLong(METADATA_KEY_OR_FLAGS, value.toLong())
    }
 ...
 */
const val METADATA_KEY_OR_FLAGS = "com.yuriy.openradio.media.METADATA_KEY_OR_FLAGS"

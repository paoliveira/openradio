...
object ImageFilePath {
    ...
    fun getPath(context: Context, uri: Uri): String {
        ...
        if (AppUtils.hasVersionKitKat() && DocumentsContract.isDocumentUri(context, uri)) {
            ...
            return if (isGooglePhotosUri(uri)) uri.lastPathSegment ?: AppUtils.EMPTY_STRING
                else getDataColumn(context, uri, uri, null, null)
        } else if ("file".equals(uri.scheme, ignoreCase = true)) {
            return uri.path ?: AppUtils.EMPTY_STRING
        }
    ...
    private fun getDataColumn(context: Context,
        ...
        try {
            ...
            AppLogger.e("Can not get data column for $originalUri", e)
        }
        return AppUtils.EMPTY_STRING
    }
